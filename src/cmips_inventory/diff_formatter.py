...
<head>
    ...
    <title>cmipsmap drift report - {esc(from_date)} to {esc(to_date)}</title>
    <style>
        :root {{
            --primary: #0972d3;
            --primary-dark: #033160;
...
<body>
    ...
    <footer>
        Generated by <a href="https://github.com/kiranrajanna/cmipsmap">cmipsmap</a> &middot; Author: Kiran Rajanna &middot; {esc(total)} resources compared
    </footer>
