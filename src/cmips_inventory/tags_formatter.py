"""
Output formatters for `cmipsmap tags` - table, JSON, HTML.
"""

import json

from cmips_inventory.report_style import esc, base_css, theme_script, row_filter_script
...
<head>
    ...
    <title>cmipsmap tag compliance</title>
    <style>{base_css()}</style>
</head>
<body>
    <header>
        <div>
            <h1>cmipsmap tag compliance</h1>
    ...
    <footer>
        Generated by <a href="https://github.com/kiranrajanna/cmipsmap">cmipsmap</a> &middot; Author: Kiran Rajanna
    </footer>
    <script>
        {theme_script()}
        {row_filter_script()}
